    ...
    return [
        ...
        },
        {
            ...
            items: [
                ...
                item(moduleEnabled('services') && can('service-orders.view'), 'Comercial', 'Servicios', route('service-orders.types.index'), route().current('service-orders.types.*'), 'ventas'),
                item((moduleEnabled('services') || moduleEnabled('service_orders')) && can('service-orders.view'), 'Comercial', 'Ordenes de servicio', route('service-orders.index'), route().current('service-orders.index') || route().current('service-orders.status'), 'ventas'),
                ...
                item(moduleEnabled('customer_qr_ordering') && can('customer-qr-orders.view'), 'Comercial', 'Pedidos QR', route('customer-qr-orders.index'), route().current('customer-qr-orders.*'), 'ventas'),
        ...
        },
        {
            ...
            items: [
                ...
                item(moduleEnabled('cash_flow') && can('cash-flow.view'), 'Finanzas', 'Flujo de efectivo', route('cash-flow.index'), route().current('cash-flow.*'), 'pagos'),
