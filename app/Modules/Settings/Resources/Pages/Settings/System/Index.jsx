    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">Sistema</h2>}>
            ...
            <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                <ModuleHeader title="Backups del sistema" description="Genera respaldos para descarga, traslado a hosting o restauracion controlada." />

                <form onSubmit={generateBackup} className="mt-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:max-w-xl">
                    <h3 className="mb-4 text-base font-semibold text-slate-900 dark:text-white">Generar backup</h3>
                    <SelectField
                        label="Formato"
                        name="format"
                    ...
                    <p className="mt-3 text-sm text-slate-500 dark:text-slate-400">
                        Se guarda en el disco local configurado por Laravel para descarga o traslado desde hosting.
                    </p>
                </form>
