...
class BusinessProfileConfiguration
{
    public static function defaults(): array
    {
        return [
            ...
            'capabilities' => [
                ...
                'uses_dynamic_pos' => false,
                'uses_commercial_flow_rules' => false,
                ...
                'uses_advanced_multibranch' => false,
            ...
            'feature_flags' => [
                ...
                'data_governance_engine' => false,
                'operational_traceability_engine' => false,
            ...
            'customer_qr_ordering' => [
                ...
                'allowed_order_types' => ['pickup', 'table', 'delivery', 'quote_request'],
            ...
            'multibranch' => [
                'enabled' => false,
                'transfer_policy' => 'basic_access',
                'stock_reserved_by_branch' => true,
                'prices_by_branch' => false,
                'cash_bank_by_branch' => true,
                'document_numbering_by_branch' => true,
                'partial_user_access' => true,
                'policies' => [],
            ],
            'report_templates' => [
                'enabled' => false,
    ...
    public static function options(): array
    {
        return [
            ...
            'posModes' => [
                'retail' => 'Retail o mostrador',
                'barcode' => 'POS por codigo de barras',
                'restaurant_table' => 'Restaurante con mesa',
                'restaurant_counter' => 'Restaurante sin mesa',
                'services' => 'Servicios',
                'reservation' => 'Reserva o cita',
                'rental' => 'Alquiler',
                'project' => 'Proyecto u obra',
                'loan' => 'Prestamo o empeno',
            ],
            'cashPolicies' => [
                'optional' => 'Caja opcional',
                'required' => 'Caja obligatoria',
                'disabled' => 'No usa caja',
            ],
            'paymentPolicies' => [
                'single' => 'Un solo pago',
                'single_or_mixed' => 'Un pago o pago mixto',
                'split' => 'Pago dividido permitido',
                'credit_allowed' => 'Credito permitido',
            ],
            'offlineModes' => [
