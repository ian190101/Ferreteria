...
class BusinessCapabilityCatalog
{
    public static function all(): array
    {
        return collect([
            ...
            self::capability('uses_document_templates', 'Documentos', 'Plantillas documentales 2.0', 'Permite definir documentos por rubro, campos, columnas, textos legales e impresora destino sin tocar plantillas actuales.', ['mixed', 'services', 'health_clinic', 'dental_clinic', 'loans']),
            ...
            self::capability('uses_ai_assistant', 'IA', 'Chatbot IA propio', 'Activa el asistente conversacional con motor Python/FastAPI, RAG y herramientas seguras sobre datos del negocio.', ['mixed', 'restaurant', 'foodtruck', 'hardware_store']),
            self::capability('uses_ai_internal_chat', 'IA', 'Chat interno ERP', 'Permite conversar con el bot desde la interfaz del ERP con texto y audio segun perfil.', ['mixed', 'hardware_store'], ['uses_ai_assistant']),
            self::capability('uses_ai_customer_bot', 'IA', 'Bot para clientes', 'Permite que clientes pregunten precios, disponibilidad, servicios o creen solicitudes desde canales externos.', ['restaurant', 'foodtruck', 'store'], ['uses_ai_assistant']),
            self::capability('uses_ai_owner_analytics', 'IA', 'Analitica para dueno', 'Permite consultar ventas, ganancias, caja, stock y reportes respetando permisos y sucursales.', ['mixed', 'hardware_store'], ['uses_ai_assistant']),
            self::capability('uses_ai_voice', 'IA', 'Audio y dictado', 'Permite recibir audio, transcribirlo y convertirlo en consulta, pedido o borrador.', ['restaurant', 'foodtruck', 'services'], ['uses_ai_assistant']),
            self::capability('uses_ai_exports', 'IA', 'Exportaciones por IA', 'Permite generar Excel o PDF desde conversaciones usando el modulo de exportaciones.', ['mixed'], ['uses_ai_assistant']),
            self::capability('uses_ai_order_capture', 'IA', 'Captura de pedidos por IA', 'Permite dictar o escribir pedidos para crear borradores, cotizaciones o solicitudes segun perfil.', ['restaurant', 'foodtruck', 'hardware_store'], ['uses_ai_assistant']),
            self::capability('uses_ai_external_api', 'IA', 'API externa IA', 'Permite que otros sistemas consuman el servicio FastAPI/Laravel con tokens, scopes y rate limits.', ['mixed'], ['uses_ai_assistant']),
